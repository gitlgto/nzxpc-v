<!--<template> 作为参考，暂不删除，后期会删除该页面-->
  <!--<div class="login">-->
    <!--<div class="login_box">-->
      <!--<div class="avatar_bar">-->
        <!--<img src="../assets/logo.png" alt="">-->
      <!--</div>-->
      <!--&lt;!&ndash;ref="form" :model="form"  v-model="form.name"&ndash;&gt;-->
      <!--<el-form ref="loginRef" :model="loginForm" :rules="loginFormRules" class="login_form">-->
        <!--&lt;!&ndash;label="活动名称" label-width="80px"&ndash;&gt;-->
...
<!--}-->
<!--</script>-->
<!--&lt;!&ndash;scoped 应用单个 而非全局 less该节点支持less语法,报错&ndash;&gt;-->
